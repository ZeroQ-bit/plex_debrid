...
SCHEMA = [
    ...
    ("Plex", [
        ...
        ("Plex library refresh", "Plex Refresh Sections", "list",
            {"show_if": {"Content Services": "Plex Watchlist"},
             "help": "Library section IDs to scan (comma-separated). Find them in Plex → Settings → Libraries, or leave blank to scan all."}),
        ...
        ("Plex library check", "Plex Library Check (section numbers)", "list",
            {"show_if": {"Content Services": "Plex Watchlist"},
             "help": "Section numbers checked for existing content before downloading (avoid duplicates)."}),
